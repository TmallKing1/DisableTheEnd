...
public class ForceSpawnCommand {
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
        dispatcher.register((CommandManager.literal("forcespawn").requires((source) -> source.hasPermissionLevel(2)))
    ...
    private static int setRotation(ServerCommandSource source, PosArgument posArgument) {
        ...
        DisableTheEnd.getConfig().getForceSpawnConfig().setSpawnRotation(vec2f);
